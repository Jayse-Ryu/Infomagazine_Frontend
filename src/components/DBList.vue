<template>
  <div class="main">
    ...
    <div class="container">
      ...
      <div class="list_area">
        <div>
          <div class="list-group-item list-group-item-action d-inline-flex justify-content-between p-1" style="border-radius: 0; border-bottom: 0;">
  ...
  export default {
    ...
    methods: {
      pagination: function(pageNum) {
        ...
        this.$parent.global_db_page = pageNum
        // Actual pagination
        if(pageNum === 1) {
    ...
    mounted() {
      ...
      if(this.$parent.global_db_page !== 1){
        this.page_current = this.$parent.global_db_page
      } else {
        this.page_current = 1
      }
