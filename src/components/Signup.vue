          ...
          <div class="form-group block">
            ...
            <div class="col-sm-12 pt-2 pb-2" id="access">
              <div class="form-check-inline">
                <input type="radio" id="access_marketer" name="access" v-model="access" value="0"
                       class="form-check-input">
                <label for="access_marketer" class="form-check-label">마케터</label>
              </div>
              <div class="form-check-inline">
                <input type="radio" id="access_client" name="access" v-model="access" value="-1"
                       class="form-check-input">
                <label for="access_client" class="form-check-label">고객(클라이언트)</label>
              </div>
            </div>
            <div class="col-sm-12 pt-1">
              <select v-if="access == 0" name="select_org" id="select_org" class="form-control" v-model="organization">
              ...
              <select v-else-if="access == -1" name="select_company" id="select_company" class="form-control"
                      v-model="company">
  ...
  export default {
    ...
    methods: {
      sign_up() {
        ...
        } else if (this.access === -2 || this.organization === -1 && this.company === -1) {
          alert('소속을 확인해주세요.')
        } else {
